...
const pokemonArr = [
    {number:"001", name: "Bulbasaur", type: "Grass & Poison", divType:"grass-poison", image:"img/001Bulbasaur.png", evolveFrom:"None", evolveTo:"Ivysaur"},
    {number:"002", name: "Ivysaur", type: "Grass & Poison", divType:"grass-poison", image:"img/002Ivysaur.png", evolveFrom:"Bulbasaur", evolveTo:"Venusaur"},
    {number:"003", name:"Venusaur", type:"Grass & Poison",divType:"grass-poison", image:"img/003Venusaur.png", evolveFrom:"Ivysaur", evolveTo:"None"},
    ...
    {number:"006", name:"Charizard", type:"Fire & Flying", divType:"fire-flying", image:"img/006Charizard.png", evolveFrom:"Charmeleon", evolveTo:"None"},
    ...
    {number:"012", name:"Butterfree", type:"Bug & Flying", divType:"bug-flying", img:"img/012Butterfree.png", evolveFrom:"Metapod", evolveTo:"None"},
    {number:"013", name:"Weedle", type:"Bug & Poison", divType:"bug-poison", img:"img/013Weedle.png", evolveFrom:"None", evolveTo:"Kakuna"},
    {number:"014", name:"Kakuna", type:"Bug & Poison", divType:"bug-poison", img:"img/014Kakuna.png", evolveFrom:"Weedle", evolveTo:"Beedrill"},
    {number:"015", name:"Beedrill", type:"Bug & Poison", divType:"bug-poison", img:"img/015Beedrill.png", evolveFrom:"Kakuna", evolveTo:"None"},
    {number:"016", name:"Pidgey", type:"Normal & Flying", divType:"normal-flying", img:"img/016Pidgey.png", evolveFrom:"None", evolveTo:"Pidgeotto"},
    {number:"017", name:"Pidgeotto", type:"Normal & Flying", divType:"normal-flying", img:"img/017Pidgeotto.png", evolveFrom:"Pidgey", evolveTo:"Pidgeot"},
    {number:"018", name:"Pidgeot", type:"Normal & Flying", divType:"normal-flying", img:"img/018Pidgeot.png", evolveFrom:"Pidgeotto", evolveTo:"None"},
    ...
    {number:"021", name:"Spearow", type:"Nomral & Flying", divType:"normal-flying", img:"img/021Spearow.png", evolveFrom:"None", evolveTo:"Fearow"},
    {number:"022", name:"Fearow", type:"Normal & Flying", divType:"normal-flying", img:"img/022Fearow.png", evolveFrom:"Spearow", evolveTo:"None"},
    ...
    {number:"031", name:"Nidoqueen", type: "Poison & Ground", divType:"poison-ground", img:"img/031Nidoqueen.png", evolveFrom:"Nidorina", evolveTo:"None"},
    ...
    {number:"034", name:"Nidoking", type: "Poison & Ground", divType:"poison-ground", img:"img/034Nidoking.png", evolveFrom:"Nidorino", evolveTo:"None"},
    {number:"035", name:"Clefairy", type: "Fairy", divType:"fairy", img:"img/035Clefairy.png", evolveFrom:"None", evolveTo:"Clefable"},
    {number:"036", name:"Clefable", type: "Fairy", divType:"fairy", img:"img/036Clefable.png", evolveFrom:"Clefairy", evolveTo:"None"},
    ...
    {number:"039", name:"Jigglypuff", type: "Normal & Fairy", divType:"normal-fairy", img:"img/039Jigglypuff.png", evolveFrom:"None", evolveTo:"Wigglytuff"},
    {number:"040", name:"Wigglytuff", type: "Normal & Fairy", divType:"normal-fairy", img:"img/040Wigglytuff.png", evolveFrom:"Jigglypuff", evolveTo:"None"},
    {number:"041", name:"Zubat", type: "Poison & Flying", divType:"poison-flying", img:"img/041Zubat.png", evolveFrom:"None", evolveTo:"Golbat"},
    {number:"042", name:"Golbat", type: "Poison & Flying", divType:"poison-flying", img:"img/042Golbat.png", evolveFrom:"Zubat", evolveTo:"None"},
    {number:"043", name:"Oddish", type: "Grass & Poison", divType:"grass-poison", img:"img/043Oddish.png", evolveFrom:"None", evolveTo:"Gloom"},
    {number:"044", name:"Gloom", type: "Grass & Poison", divType:"grass-poison", img:"img/044Gloom.png", evolveFrom:"Oddish", evolveTo:"Vileplume"},
    {number:"045", name:"Vileplume", type: "Grass & Poison", divType:"grass-poison", img:"img/045Vileplume.png", evolveFrom:"Gloom", evolveTo:"None"},
    {number:"046", name:"Paras", type: "Bug & Grass", divType:"bug-grass", img:"img/046Paras.png", evolveFrom:"None", evolveTo:"Parasect"},
    {number:"047", name:"Parasect", type: "Bug & Grass", divType:"bug-grass", img:"img/047Parasect.png", evolveFrom:"Paras", evolveTo:"None"},
    {number:"048", name:"Venonat", type: "Bug & Poison", divType:"bug-poison", img:"img/048Venonat.png", evolveFrom:"None", evolveTo:"Venomoth"},
    {number:"049", name:"Venomoth", type: "Bug & Poison", divType:"bug-poison", img:"img/049Venomoth.png", evolveFrom:"Venonat", evolveTo:"None"},
    ...
    {number:"062", name:"Poliwrath", type: "Water & Fighting", divType:"water-fighting", img:"img/062Poliwrath.png", evolveFrom:"Poliwhirl", evolveTo:"None"},
    ...
    {number:"069", name:"Bellsprout", type: "Grass & Poison", divType:"grass-poison", img:"img/069Bellsprout.png", evolveFrom:"None", evolveTo:"Weepinbell"},
    {number:"070", name:"Weepinbell", type: "Grass & Poison", divType:"grass-poison", img:"img/070Weepinbell.png", evolveFrom:"Bellsprout", evolveTo:"Victreebel"},
    {number:"071", name:"Victreebel", type: "Grass & Poison", divType:"grass-poison", img:"img/071Victreebel.png", evolveFrom:"Weepinbell", evolveTo:"None"},
    {number:"072", name:"Tentacool", type: "Water & Poison", divType:"water-poiso", img:"img/072Tentacool.png", evolveFrom:"None", evolveTo:"Tentacruel"},
    {number:"073", name:"Tentacruel", type: "Water & Poison", divType:"water-poiso", img:"img/073Tentacruel.png", evolveFrom:"Tentacool", evolveTo:"None"},
    {number:"074", name:"Geodude", type: "Rock & Ground", divType:"rock-ground", img:"img/074Geodude.png", evolveFrom:"None", evolveTo:"Graveler"},
    {number:"075", name:"Graveler", type: "Rock & Ground", divType:"rock-ground", img:"img/075Graveler.png", evolveFrom:"Geodude", evolveTo:"Golem"},
    {number:"076", name:"Golem", type: "Rock & Ground", divType:"rock-ground", img:"img/076Golem.png", evolveFrom:"Graveler", evolveTo:"None"},
    ...
    {number:"079", name:"Slowpoke", type: "Water & Psychic", divType:"water-psychic", img:"img/079Slowpoke.png", evolveFrom:"None", evolveTo:"Slowbro"},
    {number:"080", name:"Slowbro", type: "Water & Psychic", divType:"water-psychic", img:"img/080Slowbro.png", evolveFrom:"Slowpoke", evolveTo:"None"},
    {number:"081", name:"Magnemite", type: "Electric & Steel", divType:"electric-steel", img:"img/081Magnemite.png", evolveFrom:"None", evolveTo:"Magneton"},
    {number:"082", name:"Magneton", type: "Electric & Steel", divType:"electric-steel", img:"img/082Magneton.png", evolveFrom:"Magnemite", evolveTo:"None"},
    {number:"083", name:"Farfecth'd", type: "Normal & Flying", divType:"normal-flying", img:"img/083Farfetch'd.png", evolveFrom:"None", evolveTo:"None"},
    {number:"084", name:"Doduo", type: "Normal & Flying", divType:"normal-flying", img:"img/084Doduo.png", evolveFrom:"None", evolveTo:"Dodrio"},
    {number:"085", name:"Dodrio", type: "Normal & Flying", divType:"normal-flying", img:"img/085Dodrio.png", evolveFrom:"Doduo", evolveTo:"None"},
    {number:"086", name:"Seel", type: "Water", divType:"water", img:"img/086Seel.png", evolveFrom:"None", evolveTo:"Dewgong"},
    {number:"087", name:"Dewgong", type: "Water & Ice", divType:"water-ice", img:"img/087Dewgong.png", evolveFrom:"Seel", evolveTo:"None"},
    ...
    {number:"091", name:"Cloyster", type: "Water & Ice", divType:"water-ice", img:"img/091Cloyster.png", evolveFrom:"Shellder", evolveTo:"None"},
    {number:"092", name:"Gastly", type: "Ghost & Poison", divType:"ghost-poison", img:"img/092Gastly.png", evolveFrom:"None", evolveTo:"Haunter"},
    {number:"093", name:"Haunter", type: "Ghost & Poison", divType:"ghost-poison", img:"img/093Haunter.png", evolveFrom:"Gastly", evolveTo:"Gengar"},
    {number:"094", name:"Gengar", type: "Ghost & Poison", divType:"ghost-poison", img:"img/094Gengar.png", evolveFrom:"Haunter", evolveTo:"None"},
    {number:"095", name:"Onix", type: "Rock & Ground", divType:"rock-ground", img:"img/095Onix.png", evolveFrom:"None", evolveTo:"None"},
    ...
    {number:"102", name:"Exeggcute", type: "Grass & Psychic", divType:"grass-psychich", img:"img/102Exeggcute.png", evolveFrom:"None", evolveTo:"Exeggutor"},
    {number:"103", name:"Exeggutor", type: "Grass & Psychic", divType:"grass-psychich", img:"img/103Exeggutor.png", evolveFrom:"Exeggcute", evolveTo:"None"},
    ...
    {number:"111", name:"Rhyhorn", type: "Ground & Rock", divType:"ground-rock", img:"img/111Rhyhorn.png", evolveFrom:"None", evolveTo:"Rhydon"},
    {number:"112", name:"Rhydon", type: "Ground & Rock", divType:"ground-rock", img:"img/112Rhydon.png", evolveFrom:"Rhyhorn", evolveTo:"None"},
    ...
    {number:"121", name:"Starmie", type: "Water & Psychic", divType:"water-psychic", img:"img/121Starmie.png", evolveFrom:"Staryu", evolveTo:"None"},
    {number:"122", name:"Mr. Mime", type: "Psychic & Fairy", divType:"psychic-fairy", img:"img/122Mr._Mime.png", evolveFrom:"None", evolveTo:"None"},
    {number:"123", name:"Scyther", type: "Bug & Flying", divType:"bug-flying", img:"img/123Scyther.png", evolveFrom:"None", evolveTo:"None"},
    {number:"124", name:"Jynx", type: "Ice & Psychic", divType:"ice-psychic", img:"img/124Jynx.png", evolveFrom:"None", evolveTo:"None"},
    ...
    {number:"130", name:"Gyrados", type: "Water & Flying", divType:"water-flying", img:"img/130Gyarados.png", evolveFrom:"Magikarp", evolveTo:"None"},
    {number:"131", name:"Lapras", type: "Water & Ice", divType:"water-ice", img:"img/131Lapras.png", evolveFrom:"None", evolveTo:"None"},
    ...
    {number:"138", name:"Omanyte", type: "Rock & Water", divType:"rock-water", img:"img/138Omanyte.png", evolveFrom:"None", evolveTo:"Omastar"},
    {number:"139", name:"Omastar", type: "Rock & Water", divType:"rock-water", img:"img/139Omastar.png", evolveFrom:"Omanyte", evolveTo:"None"},
    {number:"140", name:"Kabuto", type: "Rock & Water", divType:"rock-water", img:"img/140Kabuto.png", evolveFrom:"None", evolveTo:"Kabutops"},
    {number:"141", name:"Kabutops", type: "Rock & Water", divType:"rock-water", img:"img/141Kabutops.png", evolveFrom:"Kabuto", evolveTo:"None"},
    {number:"142", name:"Aerodactyl", type: "Rock & Flying", divType:"rock-flying", img:"img/142Aerodactyl.png", evolveFrom:"None", evolveTo:"None"},
    {number:"143", name:"Snorlax", type: "Normal", divType:"normal", img:"img/143Snorlax.png", evolveFrom:"None", evolveTo:"None"},
    {number:"144", name:"Articuno", type: "Ice & Flying", divType:"ice-flying", img:"img/144Articuno.png", evolveFrom:"None", evolveTo:"None"},
    {number:"145", name:"Zapdos", type: "Electric & Flying", divType:"electric-flying", img:"img/145Zapdos.png", evolveFrom:"None", evolveTo:"None"},
    {number:"146", name:"Moltres", type: "Fire & Flying", divType:"fire-flying", img:"img/146Moltres.png", evolveFrom:"None", evolveTo:"None"},
    ...
    {number:"149", name:"Dragonite", type: "Dragon & Flying", divType:"dragon-flying", img:"img/149Dragonite.png", evolveFrom:"Dragonair", evolveTo:"None"},
